...
import fgl.freecompile.net.Interpreter;
...
public class Helper {
	...
	public static void DefineVarObjectInt(String name,String type,List<VariableType> VarList)
	{
    	...
    	{
    		case "integer":
    			VariableType intT= new VariableType(name,(int)0,VarType.Integer);
    			VarList.add(intT);
    		break;
    		case "string":
    			VariableType strT= new VariableType(name,"",VarType.String);
    			VarList.add(strT);
        		break;
    		case "boolean":
    			VariableType boolT= new VariableType(name,false,VarType.Boolean);
    			VarList.add(boolT);
    			break;
    		case "byte":
    			VariableType byteT= new VariableType(name,(byte)0,VarType.Byte);
    			VarList.add(byteT);
    			break;
    		case "cardinal":
    			break;
    		case "char":
    			VariableType charT= new VariableType(name,(char)0,VarType.Char);
    			VarList.add(charT);
    			break;
    		case "currency":
    		...
    		//	break;
    		case "int64":
    			VariableType int64T= new VariableType(name,(long)0,VarType.Int64);
    			VarList.add(int64T);
    			break;
    		case "longint":
    			VariableType longintT= new VariableType(name,(long)0,VarType.Longint);
    		...
    		//	break;
    		case "real":
    			VariableType realT= new VariableType(name,(float)0,VarType.Real);
    			VarList.add(realT);
    			break;
    		case "shortint":
    			VariableType shortintT= new VariableType(name,(short)0,VarType.Real);
		    ...
		    return new Object() {
		        ...
		        double parseFactor() {
		            ...
		            if (eat('(')) { // parentheses
		                ...
		                if (FindVarByName(var)!=null)
		                	x=Double.parseDouble(GetVarNumberValue(var)); 
		                else
